...
saved_model = open('SARIMAX_Full_Model_Best.sav', 'rb') 
...
def main(): 
    ...
    st.set_page_config(
    page_title="Corrosion Rate Prediction",
    page_icon="🧊",
    layout="centered",
    initial_sidebar_state="expanded",
    menu_items={
        'About': "# This applications forecasts the corrosion rate for the given number of future days based on the attributes trained in the model"
    }
)
    ...
    if st.button("PREDICT"): 
        ...
        predictions = st.dataframe(predictions)
